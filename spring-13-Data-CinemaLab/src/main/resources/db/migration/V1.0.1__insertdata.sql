INSERT INTO location (name, address, postal_code, country, state, city)
...
VALUES (113, 'The Gentleman', 20.0, '2020-01-24 00:00:01', 'ACTIVE',
       ...
       (100, 'The Nights Before Christmas', 28.00, '2020-11-19 00:00:01', 'ACTIVE',
        'A murderous Santa and Mrs Claus play a cat and mouse game with the FBI.', 'REGULAR'),
...
INSERT INTO account_details (address, age, city, country, name, postal_code, role, state)
VALUES ('262  Lochmere Lane', 35, 'LOUISVILLE', 'United States', 'Josie D Story', '40289', 'ADMIN', 'Kentucky'),
...
VALUES ('josie_story@email.com', '123123123', 'josieStory',
       ...
       ('lawrence.f@email.com', '123123123', 'lawrence.f',
...
VALUES ('2020-12-05 20:00:00', 14, 15, (SELECT id
       ...
       ('2020-12-05 20:00:00', 18, 7, (SELECT id
                                       FROM movie_cinema
                                       WHERE cinema_id = (SELECT c.id FROM cinema c WHERE c.name = 'Hall 1 - EMPIRE')
                                         AND movie_id = (SELECT m.id FROM movie m WHERE m.name = 'The Gentleman')
       ...
       ('2020-12-05 20:00:00', 9, 9, (SELECT id
                                      ...
                                      WHERE cinema_id = (SELECT c.id FROM cinema c WHERE c.name = 'Hall 1 - EMPIRE')
                                        AND movie_id = (SELECT m.id FROM movie m WHERE m.name = 'The Gentleman')
                                      LIMIT 1), (SELECT id from user_account WHERE email = 'faith.p@email.com')),
